...
DOCS: list[Doc] = [
    ...
    Doc(
        # The official EN 16931 UBL credit note example (ubl-tc434-creditnote1.xml),
        # printed as a supplier would: one zero-rated line, no original invoice.
        name="credit_note_be_scan",
        schema="credit_note",
        pages=[[
            ("title", "CREDIT NOTE / NOTE DE CREDIT"),
            ("gap", 20),
            ("cols",
             ["My Supplier Company N.V.", "De Grote Meir 22", "2000 ANTWERPEN", "VAT: BE0000000196"],
             ["Credit note no.: 018304 / 28865", "Date: 23/09/2019"]),
            ("gap", 40),
            ("line", "Customer:"),
            ("lines", ["My Customer Company S.A.", "Boulevard Sint Michel 53", "1000 BRUXELLES"]),
            ("gap", 40),
            ("table", Table(
                ["Description", "Qty", "Unit price", "Amount"],
                [["Exoneration du versement du PP", "1", "100.11", "100.11"]],
                [0.52, 0.12, 0.18, 0.18], "lrrr")),
            ("gap", 20),
            ("right", ["Total excl. VAT: EUR 100.11", "VAT 0%: EUR 0.00", "Total incl. VAT: EUR 100.11"]),
        ]],
        expected={
            "doc_type": "credit_note", "credit_note_number": "018304 / 28865", "issue_date": "2019-09-23",
            "seller.name": "My Supplier Company N.V.", "buyer.name": "My Customer Company S.A.",
            "subtotal": 100.11, "tax_amount": 0.0, "total_amount": 100.11, "currency": "EUR",
        },
        line_items=[{"description": "Exoneration du versement du PP", "quantity": 1, "total": 100.11}],
    ),
    Doc(
        name="credit_note_de_scan",
        schema="credit_note",
        pages=[[
            ("title", "GUTSCHRIFT"),
            ("gap", 20),
            ("cols",
             ["Holzwerk Bayern GmbH", "Industriestr. 8", "83022 Rosenheim", "USt-IdNr.: DE811907980"],
             ["Gutschrift-Nr.: GS-2026-0412", "Datum: 14.08.2026", "zur Rechnung: RE-2026-1188"]),
            ("gap", 40),
            ("line", "Kunde:"),
            ("lines", ["Schreinerei Maier KG", "Werkstrasse 3", "83022 Rosenheim"]),
            ("gap", 30),
            ("line", "Grund: Preisnachlass wegen Transportschaden"),
            ("gap", 30),
            ("table", Table(
                ["Bezeichnung", "Menge", "Einzelpreis", "Betrag"],
                [["Eichenbretter 30 mm", "4", "62,50", "250,00"],
                 ["Buchenleisten", "10", "8,00", "80,00"]],
                [0.50, 0.12, 0.19, 0.19], "lrrr")),
            ("gap", 20),
            ("right", ["Nettobetrag: 330,00 EUR", "USt. 19 %: 62,70 EUR", "Gesamtbetrag: 392,70 EUR"]),
        ]],
        expected={
            "doc_type": "credit_note", "credit_note_number": "GS-2026-0412", "issue_date": "2026-08-14",
            "seller.name": "Holzwerk Bayern GmbH", "buyer.name": "Schreinerei Maier KG",
            "seller.tax_ids[0].value": "DE811907980", "subtotal": 330.0, "tax_amount": 62.7,
            "total_amount": 392.7, "currency": "EUR",
        },
        line_items=[
            {"description": "Eichenbretter 30 mm", "quantity": 4, "total": 250.0},
            {"description": "Buchenleisten", "quantity": 10, "total": 80.0},
        ],
    ),
    Doc(
        name="credit_note_es_scan",
        schema="credit_note",
        pages=[[
            ("title", "FACTURA RECTIFICATIVA"),
            ("gap", 20),
            ("cols",
             ["Suministros Levante SL", "Calle Colon 14", "46004 Valencia", "NIF: ESB86561412"],
             ["N.o rectificativa: R-2026-0077", "Fecha: 02/07/2026", "Factura rectificada: F-2026-0931"]),
            ("gap", 40),
            ("line", "Cliente:"),
            ("lines", ["Talleres Montjuic SA", "Carrer de Sants 120", "08014 Barcelona"]),
            ("gap", 30),
            ("line", "Motivo: devolucion de mercancia"),
            ("gap", 30),
            ("table", Table(
                ["Concepto", "Cant.", "Precio", "Importe"],
                [["Tornillo inox M8 (caja)", "6", "24,50", "147,00"],
                 ["Arandela plana M8 (caja)", "6", "9,00", "54,00"]],
                [0.50, 0.12, 0.19, 0.19], "lrrr")),
            ("gap", 20),
            ("right", ["Base imponible: 201,00 EUR", "IVA 21 %: 42,21 EUR", "Total: 243,21 EUR"]),
        ]],
        expected={
            "doc_type": "credit_note", "credit_note_number": "R-2026-0077", "issue_date": "2026-07-02",
            "seller.name": "Suministros Levante SL", "buyer.name": "Talleres Montjuic SA",
            "seller.tax_ids[0].value": "ESB86561412", "subtotal": 201.0, "tax_amount": 42.21,
            "total_amount": 243.21, "currency": "EUR",
        },
        line_items=[
            {"description": "Tornillo inox M8 (caja)", "quantity": 6, "total": 147.0},
            {"description": "Arandela plana M8 (caja)", "quantity": 6, "total": 54.0},
        ],
    ),
    Doc(
